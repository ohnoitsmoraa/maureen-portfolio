					...
					<div className=" flex flex-col justify-between items-center md:items-start">
						...
						<motion.div variants={fadeIn("tween", 0.2, 0.7)}>
							...
							<p className="mb-2 text-center md:text-left">
								...
								<br /> <strong>Python</strong> and the <strong>Flask</strong> web framework. 
								<br /> I specialize in builiding scalable, high - performance web applications 
								and backend systems. With a strong <br /> foundation in problem solving and code 
								optimization, I enjoy taking on complex technical challenges and delivering clean, 
								efficient and maintanable code.
							</p>
						</motion.div>
